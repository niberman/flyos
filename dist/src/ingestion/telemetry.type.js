...
let TelemetryType = class TelemetryType {
    id;
    aircraftId;
    timestamp;
    data;
...
__decorate([
    (0, graphql_1.Field)(() => graphql_type_json_1.GraphQLJSON, {
        description: 'Raw JSONB sensor data (e.g., { oilPressure: 45, cylinderHeadTemperature: 380 }).',
    }),
    __metadata("design:type", Object)
], TelemetryType.prototype, "data", void 0);
exports.TelemetryType = TelemetryType = __decorate([
    (0, graphql_1.ObjectType)('Telemetry', {
        description: 'A telemetry data point containing sensor readings for an aircraft.',
    })
], TelemetryType);
//# sourceMappingURL=telemetry.type.js.map